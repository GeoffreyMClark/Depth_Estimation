...
model_path = '/tfdepth/rss/model_v6'
...
for j in range (len(model_path)):
    ...
    for i in range (0, int(len(train_data)/2), 2):
        ...
        print(f"Runtime of the inference is {end - start}")
...
with open('/tfdepth/rss/eval/eval_model_v8.txt', 'w') as f:
